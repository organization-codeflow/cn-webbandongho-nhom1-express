...
```bash
git clone https://github.com/organization-codeflow/cn-webbandongho-nhom1-express.git
cd cn-webbandongho-nhom1-express
```
...
- Truy cập: https://sonarcloud.io/project/overview?id=cn-webbandongho-nhom1-express
- Xem các metrics:
